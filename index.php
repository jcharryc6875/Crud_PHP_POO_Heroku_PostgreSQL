...
<table class="ui inverted olive">
    ...
    <tr>
        ...
        <td>
            ...
            <a class="ui red button" href="index.php?edit=<?php echo $row['empleado_id'];?>"> Edit</a>
        </td>
        <td>
           <!-- 11)BORRAR REGISTROS-->
            <a class="ui green button" href="server.php?del=<?php echo $row['empleado_id'];?>">Delete</a>
        </td>
    </tr>
